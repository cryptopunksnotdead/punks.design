...
var _user$project$Main$createDeck = {
	ctor: '::',
	_0: A3(_user$project$Main$Card, 1, _user$project$Main$A, false),
	_1: {
		ctor: '::',
		...
		_1: {
			...
			_1: {
				...
				_1: {
					ctor: '::',
					_0: A3(_user$project$Main$Card, 5, _user$project$Main$A, false),
					_1: {
						ctor: '::',
							...
							_1: {
								...
								_1: {
									...
									_1: {
										...
										_1: {
											ctor: '::',
											_0: A3(_user$project$Main$Card, 3, _user$project$Main$B, false),
											_1: {
												ctor: '::',
												...
												_1: {
													...
													_1: {
														ctor: '::',
														_0: A3(_user$project$Main$Card, 6, _user$project$Main$B, false),
														_1: {
															ctor: '::',
...
var _user$project$Main$MatchCard = F3(
	function (a, b, c) {
		return {ctor: 'MatchCard', _0: a, _1: b, _2: c};
	});
var _user$project$Main$Guessing = F2(
	function (a, b) {
		return {ctor: 'Guessing', _0: a, _1: b};
	});
...
var _user$project$Main$viewGame = function (deck) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		},
		{
			...
			_1: A2(_elm_lang$core$List$map, _user$project$Main$viewCard, deck)
		});
};
var _user$project$Main$Shuffle = function (a) {
	return {ctor: 'Shuffle', _0: a};
};
var _user$project$Main$createModel = function () {
	var deck = _user$project$Main$createDeck;
	var model = _user$project$Main$Playing(deck);
	var cmd = A2(
		_user$project$Main$randomList,
		_user$project$Main$Shuffle,
		_elm_lang$core$List$length(deck));
		...
		switch (_p4.ctor) {
			case 'NoOp':
				return A2(
					...
					{ctor: '[]'});
			case 'Shuffle':
				var newDeck = A2(_user$project$Main$shuffleDeck, _user$project$Main$createDeck, _p4._0);
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
	...
	function (card, model) {
		...
		switch (_p6.ctor) {
			case 'Playing':
				...
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					A2(_user$project$Main$Guessing, newDeck, card),
					{ctor: '[]'});
			case 'Guessing':
				var newDeck = A2(
					_elm_lang$core$List$map,
				...
				var isOver = A2(
					...
					newDeck);
				var newModel = isOver ? _user$project$Main$GameOver(newDeck) : A3(_user$project$Main$MatchCard, newDeck, _p6._1, card);
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					newModel,
					{ctor: '[]'});
			case 'MatchCard':
				...
				var _p9 = _p6._1;
				var _p8 = _p6._0;
				if (_elm_lang$core$Native_Utils.eq(_p9.id, _p10.id)) {
					return A2(
						_user$project$Main$update,
						_user$project$Main$Flip(card),
						_user$project$Main$Playing(_p8));
				} else {
					var flipGuess = function (_p7) {
						return A3(
							_user$project$Main$flip,
							false,
							_p10,
							A3(_user$project$Main$flip, false, _p9, _p7));
					};
					var newDeck = A2(_elm_lang$core$List$map, flipGuess, _p8);
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						_user$project$Main$Playing(newDeck),
						{ctor: '[]'});
			...
			default:
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_user$project$Main$GameOver(_p6._0),
					{ctor: '[]'});
		}
	});
var _user$project$Main$Reset = {ctor: 'Reset'};
var _user$project$Main$viewPlayAgainOverlay = A2(
	_elm_lang$html$Html$div,
	{
		ctor: '::',
		_0: _elm_lang$html$Html_Attributes$id('congrats'),
		_1: {ctor: '[]'}
	},
	{
		ctor: '::',
		_0: A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html$text('Congrats! You win!'),
				_1: {ctor: '[]'}
			}),
		_1: {
			ctor: '::',
...
var _user$project$Main$viewGameOver = function (deck) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			ctor: '::',
			_0: _user$project$Main$viewGame(deck),
			_1: {
				ctor: '::',
				_0: _user$project$Main$viewPlayAgainOverlay,
				_1: {ctor: '[]'}
			}
		});
};
var _user$project$Main$view = function (model) {
	...
	switch (_p11.ctor) {
		case 'Playing':
			return _user$project$Main$viewGame(_p11._0);
		case 'Guessing':
			return _user$project$Main$viewGame(_p11._0);
		case 'MatchCard':
			return _user$project$Main$viewGame(_p11._0);
		default:
			return _user$project$Main$viewGameOver(_p11._0);
	}
};
